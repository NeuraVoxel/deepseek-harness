...
export const PANORAMA_SKELETON: SkeletonGraph = {
  ...
  nodes: [
    ...
    { id: 'tools', label: 'Tools', x: 875, y: 148, w: 56, h: 56, fill: '#3a1530', detail: 'Tool executions', shape: 'circle', type: 'tool' },
    ...
    { id: 'preset', label: 'Preset / subagent', x: 500, y: 220, w: 140, h: 40, fill: '#1a2740', detail: 'Optional spur' },
  ],
  edges: [
  ...
  groups: [
    { id: 'g-client', label: 'Client', memberIds: ['client', 'render'], x: 20, y: 20, w: 1280, h: 260 },
  ],
}
