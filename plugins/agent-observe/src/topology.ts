/**
 * Build an Agent Observe snapshot from live Host registries.
 *
...
import type { AgentObserveEdge, AgentObserveNode, AgentObserveSnapshot } from './types.ts'
 ...
 */
export function buildLiveTopology(ctx: Context): AgentObserveSnapshot {
  ...
  const nodes: AgentObserveNode[] = []
  const edges: AgentObserveEdge[] = []
