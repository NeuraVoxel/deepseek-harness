# Parallel tool columns on agent-observe flow

English | [中文](2026-09-07-agent-observe-parallel-flow-layout.zh.md)

**Status:** approved (2026-09-07)

**Scope:** `plugins/agent-observe` flow layout only (option A: sibling tool calls from one assistant message)
