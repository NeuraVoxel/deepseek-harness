...
| [008 · dsh-base 插件](./008-dsh-base挂载了哪些插件.md) | Host 共享核心（base）挂了什么；preset 再叠 Agent 平面 |
| [009 · patch vs agent.cordis](./009-cordis.patch与agent.cordis的区别.md) | `cordis.patch.yml`（Host）与 `agent.cordis.yml`（本篇）语法与边界 |
