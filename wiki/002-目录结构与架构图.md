...
完整组名表以 [`packages/README.md`](../packages/README.md) 为准；包级一句速查见 [011 · 插件分组与主要作用](./011-插件分组与主要作用.md)。本文是公众号向的压缩地图，不替代官方包组清单。
...
- [008 · dsh-base 挂载了哪些插件](./008-dsh-base挂载了哪些插件.md)
- [011 · 插件分组与主要作用](./011-插件分组与主要作用.md)
