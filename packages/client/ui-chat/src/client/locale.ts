...
export const zh = {
  ...
  'message.turnUsage.consumedWithCost': '用量 {total} · {cost}',
  'message.turnUsage.costTitle': '估算花费',
  'message.turnUsage.costTitlePeak': '估算花费（高峰）',
  'message.turnUsage.costTotal': '合计',
  'message.turnUsage.currencyCode': 'CNY',
  'message.turnUsage.money': '¥{amount}',
...
export const en = {
  ...
  'message.turnUsage.count': '{count} tok',
  'message.turnUsage.consumedWithCost': 'Usage {total} · {cost}',
  'message.turnUsage.costTitle': 'Estimated cost',
  'message.turnUsage.costTitlePeak': 'Estimated cost (peak)',
  'message.turnUsage.costTotal': 'Total',
  'message.turnUsage.currencyCode': 'USD',
  'message.turnUsage.money': '${amount}',
